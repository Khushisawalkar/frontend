  ...
  return (
    <main className="relative min-h-screen overflow-hidden flex flex-col items-center justify-center">
      ...
      <div className="relative z-10 flex flex-col items-center text-center px-6 mt-20">
        ...
        <p className="text-white/60 max-w-lg mx-auto text-lg mb-12">
          Experience the power of our real-time telemetry streaming protocol in action. The live sandbox environment is booting up.
        </p>

        <div className="w-full max-w-3xl aspect-video bg-black/50 border border-white/10 rounded-2xl flex items-center justify-center shadow-2xl backdrop-blur-sm mb-12 relative overflow-hidden group">
