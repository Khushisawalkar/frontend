    ...
    <div className="w-full flex justify-center pt-6 px-6 absolute top-0 z-50">
      <nav className="w-full max-w-[1400px] bg-[#0F171A]/90 backdrop-blur-md border border-[var(--color-mystic-mint)]/10 rounded-full h-16 flex items-center justify-between px-6 lg:px-8 shadow-2xl">
        ...
        <div className="hidden md:flex items-center gap-4">
          <button className="text-sm font-medium text-[var(--color-arctic-powder)] hover:text-arctic transition-colors">
            Login
          </button>
          <button className="px-5 py-2 rounded-full font-medium text-sm border border-[var(--color-mystic-mint)]/20 text-[var(--color-arctic-powder)] hover:bg-arctic/5 transition-colors">
            Contact Sales
          </button>
