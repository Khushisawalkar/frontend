        ...
        <div className="flex flex-col items-start justify-center h-full pt-12 lg:pt-0">
          ...
          <div className="flex flex-col sm:flex-row gap-4 mb-16">
            ...
            <button className="flex items-center justify-center gap-3 px-8 py-3.5 rounded-lg font-medium text-[var(--color-arctic-powder)] border border-[var(--color-mystic-mint)]/20 hover:bg-white/5 transition-colors bg-[#172B36]/30">
              Read the Docs
              <span className="flex items-center justify-center w-5 h-5 rounded bg-white/10 text-[10px] font-mono border border-white/10 text-[var(--color-arctic-powder)]/60">F</span>
            </button>
          </div>
