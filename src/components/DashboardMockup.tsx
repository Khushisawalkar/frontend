          ...
          <div className="absolute inset-4 md:inset-8 top-12 bg-[var(--color-nocturnal-expedition)]/40 backdrop-blur-3xl rounded-[2.5rem] border border-[var(--color-mystic-mint)]/10 shadow-[0_40px_100px_rgba(0,0,0,0.5)] overflow-hidden">
            ...
            <div className="p-8 h-full flex flex-col gap-6">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                {[...Array(3)].map((_, i) => (
                  <div key={i} className="h-24 rounded-2xl bg-black/20 border border-[var(--color-mystic-mint)]/5 relative overflow-hidden group">
              ...
              <div className="flex-1 rounded-2xl bg-black/40 border border-[var(--color-mystic-mint)]/5 relative overflow-hidden flex items-end">
