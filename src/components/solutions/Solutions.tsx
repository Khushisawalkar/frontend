      ...
      <div className="section max-w-7xl mx-auto px-6">
        ...
        <div className="mb-32 text-center max-w-3xl mx-auto">
          <h2 className="text-[2.5rem] md:text-[3.5rem] font-medium mb-6 tracking-tight text-[#F1F6F4]/95 leading-tight">
            Designed for <br />
            <span className="text-[#F1F6F4]/60 italic font-serif">every stage of growth.</span>
          </h2>
        ...
        <div className="flex flex-col gap-32">
          ...
          <div className="flex flex-col md:flex-row items-center gap-20 group">
            <div className="flex-1 order-2 md:order-1 relative w-full">
              ...
              <div className="w-full aspect-[4/3] rounded-[2rem] bg-[#F1F6F4]/[0.02] border border-[#F1F6F4]/5 flex items-center justify-center p-8 relative overflow-hidden backdrop-blur-xl shadow-[0_20px_60px_rgba(0,0,0,0.1)] transition-transform duration-1000 group-hover:scale-[1.02]">
                 
                 {/* Soft Glass Composition */}
                 <div className="relative w-48 h-56 rounded-3xl border border-[#F1F6F4]/10 bg-gradient-to-b from-[#F1F6F4]/10 to-transparent backdrop-blur-md shadow-2xl flex flex-col p-6 overflow-hidden animate-float">
                    ...
                    <div className="space-y-3 opacity-60">
                      <div className="h-1.5 w-full bg-[#F1F6F4]/20 rounded-full" />
                      <div className="h-1.5 w-2/3 bg-[#F1F6F4]/10 rounded-full" />
                    </div>
                 </div>

                 {/* Floating accents */}
                 <div className="absolute right-[15%] top-[20%] w-16 h-16 rounded-full border border-[#F1F6F4]/5 bg-[#172B36]/50 backdrop-blur-sm animate-float-gentle" style={{ animationDelay: '1s' }} />
            ...
            <div className="flex-1 order-1 md:order-2">
              <div className="inline-flex items-center gap-3 mb-8">
                ...
                <span className="text-[13px] font-medium tracking-widest uppercase text-[#F1F6F4]/60">Enterprise</span>
              </div>
              <h3 className="text-3xl font-medium mb-6 tracking-tight text-[#F1F6F4]/90 leading-snug">
                Absolute security, <br /> seamlessly integrated.
              </h3>
              <p className="text-[16px] text-[#F1F6F4]/50 mb-10 leading-relaxed font-light">
              ...
              <Link href="/get-started" className="inline-flex items-center gap-3 text-[15px] font-medium text-[#F1F6F4] hover:text-[#F1F6F4]/70 transition-colors group/link">
          ...
          <div className="flex flex-col md:flex-row items-center gap-20 group">
            <div className="flex-1">
              <div className="inline-flex items-center gap-3 mb-8">
                <span className="h-px w-8 bg-[#F1F6F4]/20" />
                <span className="text-[13px] font-medium tracking-widest uppercase text-[#F1F6F4]/60">Startups</span>
              </div>
              <h3 className="text-3xl font-medium mb-6 tracking-tight text-[#F1F6F4]/90 leading-snug">
            ...
            <div className="flex-1 relative w-full">
              ...
              <div className="w-full aspect-[4/3] rounded-[2rem] bg-[#F1F6F4]/[0.02] border border-[#F1F6F4]/5 flex items-center justify-center p-8 relative overflow-hidden backdrop-blur-xl shadow-[0_20px_60px_rgba(0,0,0,0.1)] transition-transform duration-1000 group-hover:scale-[1.02]">
                 ...
                 <div className="relative w-56 p-8 rounded-3xl border border-[#F1F6F4]/10 bg-gradient-to-b from-[#114C5A]/10 to-transparent backdrop-blur-md shadow-2xl flex flex-col items-center animate-float">
                   <div className="text-[11px] font-mono tracking-widest text-[#F1F6F4]/40 mb-4">ACTIVE NODES</div>
                   <div className="text-5xl font-light text-[#F1F6F4]/90 mb-2">4k</div>
