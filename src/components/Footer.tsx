    ...
    <footer className="bg-[var(--color-oceanic-noir)] pt-24 pb-12 border-t border-[var(--color-mystic-mint)]/10 text-[var(--color-arctic-powder)] relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 lg:px-12 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
          <div className="md:col-span-1">
            <div className="flex items-center gap-3 mb-6">
              <div className="w-8 h-8 bg-[var(--color-nocturnal-expedition)] rounded-lg flex items-center justify-center border border-[var(--color-mystic-mint)]/20">
                <div className="w-5 h-5 bg-[var(--color-forsythia)]" style={{ maskImage: "url('/SVGs/cube-16-solid.svg')", maskSize: "contain", maskRepeat: "no-repeat", maskPosition: "center", WebkitMaskImage: "url('/SVGs/cube-16-solid.svg')", WebkitMaskSize: "contain", WebkitMaskRepeat: "no-repeat", WebkitMaskPosition: "center" }} />
              </div>
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm text-[var(--color-mystic-mint)]/70">
              <li><a href="#" className="hover:text-[var(--color-forsythia)] transition-colors flex items-center gap-2">API Documentation <div className="w-3 h-3 bg-current" style={{ maskImage: "url('/SVGs/link.svg')", maskSize: "cover", WebkitMaskImage: "url('/SVGs/link.svg')" }} /></a></li>
              <li><a href="#" className="hover:text-[var(--color-forsythia)] transition-colors flex items-center gap-2">GitHub <div className="w-3 h-3 bg-current" style={{ maskImage: "url('/SVGs/link-solid.svg')", maskSize: "cover", WebkitMaskImage: "url('/SVGs/link-solid.svg')" }} /></a></li>
          ...
          <div>
            ...
            <div className="flex items-center gap-4 text-sm text-[var(--color-mystic-mint)]/70">
              <button className="w-8 h-8 rounded-full border border-[var(--color-mystic-mint)]/20 flex items-center justify-center hover:bg-[var(--color-forsythia)] hover:text-[var(--color-oceanic-noir)] transition-colors">
                <div className="w-3 h-3 bg-current" style={{ maskImage: "url('/SVGs/chevron-left.svg')", maskSize: "cover", WebkitMaskImage: "url('/SVGs/chevron-left.svg')" }} />
              </button>
              <span className="font-mono text-xs">Page 1 of 5</span>
              <button className="w-8 h-8 rounded-full border border-[var(--color-mystic-mint)]/20 flex items-center justify-center hover:bg-[var(--color-forsythia)] hover:text-[var(--color-oceanic-noir)] transition-colors">
                <div className="w-3 h-3 bg-current" style={{ maskImage: "url('/SVGs/chevron-right.svg')", maskSize: "cover", WebkitMaskImage: "url('/SVGs/chevron-right.svg')" }} />
              </button>
            </div>
          </div>
        </div>
        ...
        <div className="pt-8 border-t border-[var(--color-mystic-mint)]/10 flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          >
            Back to top
            <div className="w-3 h-3 bg-current" style={{ maskImage: "url('/SVGs/chevron-up.svg')", maskSize: "cover", WebkitMaskImage: "url('/SVGs/chevron-up.svg')" }} />
          </a>
        </div>
      </div>
    </footer>
